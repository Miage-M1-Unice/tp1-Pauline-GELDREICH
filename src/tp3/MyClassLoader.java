...
public class MyClassLoader extends SecureClassLoader {
    ...
    public static void main(String[] args) {
        ...
        al.add(new File("/Users/pauline"));
        al.add(new File("/Users/pauline/Desktop/programmation_avancée/projet_test/out/production/projet_test/"));
        MyClassLoader myCL = new MyClassLoader(al);
        try {
            Class cl = myCL.loadClass("tp.Test");
